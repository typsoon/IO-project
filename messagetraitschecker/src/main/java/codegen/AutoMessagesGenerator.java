...
import static codegen.CodegenConfig.UNKNOWN_TYPE_MEANS_ENUM;
...
import static com.palantir.javapoet.TypeName.INT;
...
import codegen.CodegenConfig.TypeNameData;
...
public class AutoMessagesGenerator {
    ...
    private MethodSpec getEncodeAndWrite(Iterable<FieldSpec> fieldSpecs, String consumerQualifiedName) {
        ...
        fieldSpecs.forEach(field -> {
            ...
            methodBuilder.addStatement(mappedVal.consumerMethod().apply(field.name()));
        });
