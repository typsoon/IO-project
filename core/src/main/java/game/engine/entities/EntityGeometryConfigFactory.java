...
public class EntityGeometryConfigFactory {
    ...
    private static final String CONFIG_PATH = "assets/geometryconfigs/";
    ...
    //problems
    //  record don't have default constructor (pojo is resolving it but i don't think its good solution)
