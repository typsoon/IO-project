...
public abstract class BasicItem implements IItem {
    ...
    @Override
    public void itemEquip(IWorldView view, IEntity user, UsageModifiers modifiers) {
    ...
    @Override
    public void secondaryAction(IWorldView view, IEntity user, UsageModifiers modifiers) {

    }

    @Override
    public void specialAction(IWorldView view, IEntity user, UsageModifiers modifiers) {
